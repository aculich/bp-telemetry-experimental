...
"""
Platform detection utilities for Antigravity database monitoring.
"""
...
def get_antigravity_database_paths() -> List[Path]:
    """
    Get Antigravity database base paths for the current platform.
    ...
    if system == "Darwin":  # macOS
        ...
        return [
            home / "AppData/Roaming/Antigravity/User/workspaceStorage",
        ]
    else:
